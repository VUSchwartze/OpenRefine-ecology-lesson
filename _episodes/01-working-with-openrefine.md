...
OpenRefine can import a variety of file types, including:
...
See the [OpenRefine Documentation on Importing Data](https://docs.openrefine.org/manual/starting#create-a-project-by-importing-data) for more information.
